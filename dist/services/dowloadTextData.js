...
var crytoDataManager = require("../Classes/crytoDataManager");
var getUnixTimeStamp = require("../utils/utils").getUnixTimeStamp;
var lib_dynamodb_1 = require("@aws-sdk/lib-dynamodb");
var downloadTextData = function () { return __awaiter(void 0, void 0, void 0, function () {
    var currencies, textDataManager, i, url, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                url = "https://www.alphavantage.co/query?function=NEWS_SENTIMENT&tickers=CRYPTO:".concat(currencies[i], "&apikey=").concat(process.env.ALPHAVANTAGE_API_KEY);
...
//# sourceMappingURL=dowloadTextData.js.map